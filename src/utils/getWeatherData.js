...
export const getWeatherData = async (fn1, fn2) => {
  const tampere = `https://api.openweathermap.org/data/2.5/weather?id=634963&appid=${API_KEY}&units=metric`
  const jyv = `https://api.openweathermap.org/data/2.5/weather?id=655195&appid=${API_KEY}&units=metric`
  const kuo = `https://api.openweathermap.org/data/2.5/weather?id=650225&appid=${API_KEY}&units=metric`
  const esp = `https://api.openweathermap.org/data/2.5/weather?id=660129&appid=${API_KEY}&units=metric`
